...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: 'Hail storms in Central Texas don\'t just damage roofs—they devastate vehicles too. Paintless Dent Repair (PDR) is the gold-standard solution for removing hail dents, door dings, and minor body damage without affecting your vehicle\'s original paint or factory finish. Our PDR specialists at Paintless Perfection use precision tools and expert techniques to massage dents out from behind panels, preserving your car\'s value and eliminating the need for expensive body shop work. PDR is faster (same-day service often available), more affordable (typically 50-70% less than traditional repair), and maintains your vehicle\'s factory paint (no color matching issues or diminished resale value). Perfect for hail damage (dozens to hundreds of dents), door dings and parking lot damage, minor collision dents, and creases from shopping carts or sports equipment. We work directly with insurance companies, provide mobile service (we come to you in Round Rock, Austin, Georgetown, Central Texas), and offer free estimates. Most insurance policies cover hail damage PDR with zero out-of-pocket cost after deductible. Get your vehicle looking new again—often in just a few hours!',
    icon: '🚗',
    ...
    process: [
      ...
      { step: 2, title: 'Insurance Coordination (If Applicable)', description: 'Most hail damage is fully covered by comprehensive auto insurance with only your deductible due. We work with ALL insurance companies—State Farm, USAA, Progressive, Geico, Allstate, and more. We help you file your claim, provide professional damage documentation, meet with insurance adjusters, ensure proper repair scope is approved, and coordinate direct payment from insurance (you pay only deductible). We handle the insurance paperwork—you just approve the repairs.' },
      { step: 3, title: 'Precision Paintless Dent Removal', description: 'Our master PDR technicians access dents from behind the panel using specialized tools. We carefully massage the metal back to its original shape, working each dent from the inside out, using precision lighting to ensure perfect results, preserving your factory paint and finish, requiring no sanding, filling, or repainting, and maintaining your vehicle\'s original value. The process is meticulous—larger hail jobs can take 1-3 days depending on dent count.' },
    ...
    benefits: [
      ...
      'Most claims: $0 out-of-pocket after deductible',
