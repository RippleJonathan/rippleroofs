        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-primary-600 max-w-3xl mx-auto">
              We provide expert roofing services throughout the Central Texas region. 
              If you don't see your city listed, give us a call—we likely serve your area!
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-center border-2 border-accent-100">
              <div className="text-4xl font-bold text-accent-600 mb-2">9+</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-center border-2 border-accent-100">
              <div className="text-4xl font-bold text-accent-600 mb-2">2.5M+</div>
            ...
            {SERVICE_AREAS.map((area) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  {area.featured && (
                    <div className="bg-accent-500 text-white text-xs font-bold px-2 py-1 rounded">
                      PRIMARY
                    </div>
                  )}
                </div>
          ...
          <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-2xl p-8 md:p-12 text-white">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-primary-100 mb-6 max-w-2xl mx-auto">
                We service many additional areas throughout Central Texas. Contact us to confirm 
                coverage in your specific location—chances are, we can help!
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-accent-500 hover:bg-accent-600 text-white font-bold py-4 px-8 rounded-lg transition-colors text-center"
              >
                📞 Call (512) 763-5277
              </a>
              <a
