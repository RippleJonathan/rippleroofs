...
export const ServiceAreasMap: FC = () => {
  const phoneNumber = '+15127635277';
  const phoneDisplay = '(512) 763-5277';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white rounded-xl shadow-lg p-6 text-center border-2 border-accent-100">
              <div className="text-4xl font-bold mb-2 text-accent-600">80+</div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-center border-2 border-accent-100">
              <div className="text-4xl font-bold mb-2 text-accent-600">24/7</div>
              <div className="text-sm text-primary-600 font-medium">Emergency Response</div>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 text-center border-2 border-accent-100">
              <div className="text-4xl font-bold mb-2 text-accent-600">2.5M+</div>
            ...
            {SERVICE_AREAS_TEXAS.map((area) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  {area.featured && (
                    <div className="text-xs font-bold px-2 py-1 rounded bg-accent-500 text-white">
                      PRIMARY
                    </div>
                  )}
                </div>
          ...
          <div className="rounded-2xl p-8 md:p-12 text-white bg-gradient-to-br from-primary-900 to-primary-800">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-4 bg-accent-500">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 font-bold py-4 px-8 rounded-lg transition-colors text-center bg-accent-500 hover:bg-accent-600 text-white"
              >
                📞 Call {phoneDisplay}
              </a>
              <a
          ...
          <div className="mt-12 bg-white rounded-xl shadow-lg p-8 border-2 border-primary-100">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="mb-3 text-accent-600">
