...
export const TrustBadgeBar: FC<TrustBadgeBarProps> = ({ variant = 'default', className = '' }) => {
  if (variant === 'compact') {
    return (
      <div className={`flex flex-wrap items-center justify-center gap-4 text-sm ${className}`}>
        <div className="flex items-center gap-2 text-primary-700">
          ...
          <span className="hidden sm:inline">from 267+ Reviews</span>
        </div>
        <div className="flex items-center gap-2 text-primary-700">
          <span className="text-accent-500 text-xl">✓</span>
      ...
      <div className={`bg-gradient-to-r from-accent-50 to-accent-100 border border-accent-200 rounded-xl p-6 ${className}`}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="text-2xl font-bold text-primary-900">4.9/5 Stars</div>
              <div className="text-sm text-primary-600">267+ Happy Customers</div>
    ...
    <div className={`bg-white border-2 border-accent-200 rounded-lg p-4 shadow-sm ${className}`}>
      <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-lg font-bold text-primary-900">4.9/5 Stars</div>
            <div className="text-xs text-primary-600">267+ Reviews</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-sm font-bold text-primary-900">24/7 Emergency</div>
            <div className="text-xs text-primary-600">Always Available</div>
          </div>
        </div>
      </div>
    </div>
