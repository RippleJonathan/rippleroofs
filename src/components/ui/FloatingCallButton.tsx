...
export const FloatingCallButton: FC = () => {
  ...
  const phone = BUSINESS_INFO_TEXAS.phone
  ...
  return (
    <>
      ...
      <a
        ...
        aria-label={`Call ${BUSINESS_INFO_TEXAS.name}`}
      >
        <div className="relative pl-5 pr-6 py-4">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <span className="absolute -inset-1 inline-flex rounded-full opacity-75 animate-ping bg-accent-400" />
            </div>
