...
export const FloatingCallButton: FC = () => {
  ...
  return (
    <>
      {/* Mobile Call Button - Always visible on mobile */}
      <a
        href={`tel:${SITE_CONFIG.phoneRaw}`}
        className="md:hidden fixed bottom-6 right-6 z-50 bg-accent-500 hover:bg-accent-600 text-white rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center group"
