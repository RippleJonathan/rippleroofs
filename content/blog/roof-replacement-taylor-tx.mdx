...
**Insurance:** Texas does not currently require roofing contractors to hold a state license, so a Certificate of Insurance is your real screening tool. Verify it directly with the carrier. Any contractor who can't provide one should be disqualified.
...
1. Can you provide a Certificate of Insurance right now? (Any established contractor should have this immediately available — Texas has no roofing license to check instead.)
...
- **Inability to provide a Certificate of Insurance on request**
