...
**Does USAA require me to use a specific roofing contractor?**
No. USAA has a preferred contractor network but participation is voluntary. You choose your own licensed contractor. USAA will pay a qualified contractor regardless of network membership.

**I'm on active duty and being deployed — can my spouse handle the claim?**
Yes. USAA is highly experienced with power-of-attorney situations and military deployment scenarios. A family member with appropriate authorization can manage the entire process. We're also experienced handling claims when the homeowner is deployed — we document damage, communicate with USAA, and coordinate with the family member on-site.

**What if I'm PCSing in 3 months — should I still file?**
Yes, if damage is legitimate. A documented roof repair or replacement on an insurance claim is a selling point. Buyers and their inspectors look for this. An undocumented damaged roof creates disclosure issues at sale.

**Does USAA cover standing seam metal or stone-coated steel upgrades?**
USAA (like all carriers) covers replacement in kind — they pay to replace your asphalt shingles with equivalent asphalt shingles. If you want to upgrade to metal roofing, USAA pays for the shingle replacement and you pay the upgrade difference. We can structure this clearly in the scope.
