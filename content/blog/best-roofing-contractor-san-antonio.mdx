...
- **CertainTeed ShingleMaster** (gaf.com/en-us/roofing-contractors)
...
A: Start with manufacturer certification programs (CertainTeed Shingle Master, CertainTeed ShingleMaster), check BBB ratings, verify Texas contractor license at tdlr.texas.gov, get 3-5 written estimates, and call references. Avoid door-knockers after storms—90% are storm chasers.
