...
- **No Texas state roofing license exists.** Texas does not require roofing contractors to hold a state license — do not write "TDLR-licensed," "verify at tdlr.texas.gov," or similar. (TDLR does not administer roofing licensure at all.) A 2025 bill, HB 3344, would have created one, but confirmed directly by the user in July 2026 that it did **not** pass — don't assume it did just because a web search surfaces the bill's proposed effective dates; bill text describes what would happen *if* passed, not enacted law. Correct framing for content: verify a contractor's **insurance** (Certificate of Insurance, checked with the carrier) and **manufacturer certification** (CertainTeed, GAF, etc.) instead of a license. This exact false claim was found in 28 files in July 2026 (including a couple that invented a "RRC.texas.gov" verification site that doesn't exist) and corrected — if you see it again, fix it the same way.
...
- **SBA Veteran-Owned Certified** — real, confirmed. Approved September 2026 (via the SBA's VetCert program, veterans.certify.sba.gov), verifying Ripple Roofing as a Veteran-Owned Small Business (VOSB) owned and controlled by Jonathan. This is a business-level federal certification — distinct from, and in addition to, Jonathan's personal Navy service (already documented above). Safe to cite as "SBA Veteran-Owned Certified" or "Veteran-Owned Small Business, certified by the U.S. Small Business Administration." Do **not** upgrade this to "Service-Disabled Veteran-Owned Small Business" (SDVOSB) — that's a separate certification category and nothing on file confirms it. Badge image lives at `public/images/sba-veteran-owned-certified.jpg`.
